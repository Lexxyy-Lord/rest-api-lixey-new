...
let anu = await fetchJson(`https://api.botcahx.biz.id/api/dowloader/fbdown?url=${url}&apikey=admgacor`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://api.botcahx.biz.id/api/dowloader/tikok?url=${url}&apikey=admgacor`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
...
if (!apikey) return res.json(loghandler.notapikey)
if(listkey.includes(apikey)){
let anu = await fetchJson(`https://api.botcahx.biz.id/api/search/pinterest?text=${q}&apikey=admgacor`)
res.json({
status: true,
creator: `${creator}`,
result: anu.result
