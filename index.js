...
app.listen(PORT, () => {
    ...
    console.log(color("> Rest api ini dibuat oleh ``Lixey-Lord``",'white'))
    console.log(color("> Buy rest api no pasaran bisa beli di Lixey-Lord,",'white'))
    console.log(color("> Whatsapp :","red"), color("\n › no : 6282141218134\n › link : https://wa.me/6282141218134",'white'))
    console.log(color("> Instagram :","red"), color("\n › name : @Lixey-Lord_\n › link : https://instagram.com/lixeystore",'white'))
